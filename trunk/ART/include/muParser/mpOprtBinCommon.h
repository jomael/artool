...
/** \brief MUP_BINARY_OPERATOR(CLASS, IDENT, PROT, TYPE, DESC, PRI, OP)
    ...
    callback classes. 
*/
#define MUP_BINARY_OPERATOR(CLASS, IDENT, PROT, TYPE, DESC, PRI, ASC, OP)  \
  class CLASS : public IOprtBin                                            \
  {                                                                        \
  public:                                                                  \
    CLASS() : IOprtBin((IDENT), (PROT), (PRI), (ASC)) {}                   \
                                                                           \
  ...
  // for string values
  MUP_BINARY_OPERATOR(OprtStrAdd, _T("//"), _T("s:ss"), string_type, _T(""), 2, oaLEFT, a+b)
  // logical operators
  MUP_BINARY_OPERATOR(OprtBAnd, _T("and"), _T("b:bb"),  bool_type, _T("less than"), 1, oaLEFT, a&&b)
  MUP_BINARY_OPERATOR(OprtBOr,  _T("or"),  _T("b:bb"),  bool_type, _T("less than"), 1, oaLEFT, a||b)
  MUP_BINARY_OPERATOR(OprtBXor, _T("xor"), _T("b:bb"),  bool_type, _T("less than"), 1, oaLEFT, (bool_type)(a^b))
...
//#undef MUP_BINARY_OPERATOR
  ...
  */
  ...
  {
  public:
    OprtEQ() : IOprtBin(_T("=="), _T("b:.."), 2, oaLEFT) {}
  ...
  */
  ...
  {
  public:
    OprtNEQ() : IOprtBin(_T("!="), _T("b:.."), 2, oaLEFT) {}
    virtual void Eval(ptr_val_type& ret, const ptr_val_type *a_pArg, int)
    { 
      *ret = *a_pArg[0] != *a_pArg[1]; 
    }
  ...
  */
  ...
  {
  public:
    OprtLT() : IOprtBin(_T("<"), _T("b:.."), 2, oaLEFT) {}
    virtual void Eval(ptr_val_type& ret, const ptr_val_type *a_pArg, int)
    { 
       *ret = *a_pArg[0] < *a_pArg[1];
    }
  ...
  */
  ...
  {
  public:
    OprtGT() : IOprtBin(_T(">"), _T("b:.."), 2, oaLEFT) {}
    virtual void Eval(ptr_val_type& ret, const ptr_val_type *a_pArg, int)
    { 
       *ret = *a_pArg[0] > *a_pArg[1]; 
    }
  ...
  */
  ...
  {
  public:
    OprtLE() : IOprtBin(_T("<="), _T("b:.."), 2, oaLEFT) {}
    virtual void Eval(ptr_val_type& ret, const ptr_val_type *a_pArg, int)
    { 
      *ret = *a_pArg[0] <= *a_pArg[1];
    }
  ...
  */
  ...
  {
  public:
    OprtGE() : IOprtBin(_T(">="), _T("b:.."), 2, oaLEFT) {}
    virtual void Eval(ptr_val_type& ret, const ptr_val_type *a_pArg, int)
    { 
       *ret = *a_pArg[0] >= *a_pArg[1]; 
    }
