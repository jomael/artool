...
MUP_NAMESPACE_START
  ...
  */
  ...
  public:
      ...
      string_type  GetArgDef() const;
      char_type  GetArgType(int a_iIdx) const;
      char_type  GetRetType() const;
  ...
  private:
      ...
      string_type  m_sArgTypes;    ///< Argument type specifiers.
      char_type  m_cRetType;       ///< Return type specifier of this function object. 
